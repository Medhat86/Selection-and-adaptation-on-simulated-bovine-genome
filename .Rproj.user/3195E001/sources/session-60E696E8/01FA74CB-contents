...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_m1"
...
m1_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m1_s, file = "m1_s.RData")
...
m1_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m1_c, file = "m1_c.RData")