...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_h2"
...
h2_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h2_s, file = "h2_s.RData")
...
h2_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h2_c, file = "h2_c.RData")