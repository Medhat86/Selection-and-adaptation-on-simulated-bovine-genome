...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_s200"
...
s200_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s200_s, file = "s200_s.RData")
...
s200_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s200_c, file = "s200_c.RData")