...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_s800"
...
s800_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s800_s, file = "s800_s.RData")
...
s800_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s800_c, file = "s800_c.RData")