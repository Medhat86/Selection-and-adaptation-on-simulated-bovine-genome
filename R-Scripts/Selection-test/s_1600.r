...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_s1600"
...
s1600_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s1600_s, file = "s1600_s.RData")
...
s1600_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s1600_c, file = "s1600_c.RData")