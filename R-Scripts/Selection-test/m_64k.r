...
m64k_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m64k_s, file = "m64k_s.RData")
...
m64k_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m64k_c, file = "m64k_c.RData")