...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_m32k"
...
m32k_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m32k_s, file = "m32k_s.RData")
...
m32k_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m32k_c, file = "m32k_c.RData")