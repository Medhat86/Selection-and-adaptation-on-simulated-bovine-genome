...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_m2k"
...
m2k_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m2k_s, file = "m2k_s.RData")
...
m2k_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m2k_c, file = "m2k_c.RData")