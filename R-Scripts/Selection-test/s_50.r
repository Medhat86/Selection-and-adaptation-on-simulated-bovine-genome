...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_s50"
...
s50_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s50_s, file = "s50_s.RData")
...
s50_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s50_c, file = "s50_c.RData")