...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_s100"
...
s100_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s100_s, file = "s100_s.RData")
...
s100_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s100_c, file = "s100_c.RData")