...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_q32"
...
q32_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q32_s, file = "q32_s.RData")
...
q32_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q32_c, file = "q32_c.RData")