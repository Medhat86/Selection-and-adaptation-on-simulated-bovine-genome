...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_q512"
...
q512_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q512_s, file = "q512_s.RData")
...
q512_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q512_c, file = "q512_c.RData")