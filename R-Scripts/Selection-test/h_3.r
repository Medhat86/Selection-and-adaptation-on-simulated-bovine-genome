...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_h3"
...
h3_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h3_s, file = "h3_s.RData")
...
h3_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h3_c, file = "h3_c.RData")