...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_h4"
...
h4_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h4_s, file = "h4_s.RData")
...
h4_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h4_c, file = "h4_c.RData")