...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_h5"
...
h5_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h5_s, file = "h5_s.RData")
...
h5_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h5_c, file = "h5_c.RData")