...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_h8"
...
h8_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h8_s, file = "h8_s.RData")
...
h8_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h8_c, file = "h8_c.RData")