...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_h7"
...
h7_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h7_s, file = "h7_s.RData")
...
h7_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h7_c, file = "h7_c.RData")