...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_q1"
...
q1_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q1_s, file = "q1_s.RData")
...
q1_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q1_c, file = "q1_c.RData")