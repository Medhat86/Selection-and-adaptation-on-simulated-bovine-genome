...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_q4"
...
q4_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q4_s, file = "q4_s.RData")
...
q4_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q4_c, file = "q4_c.RData")