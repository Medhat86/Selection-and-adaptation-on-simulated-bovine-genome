...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_h95"
...
h95_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h95_s, file = "h95_s.RData")
...
h95_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h95_c, file = "h95_c.RData")