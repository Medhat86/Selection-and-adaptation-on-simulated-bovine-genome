...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_h9"
...
h9_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h9_s, file = "h9_s.RData")
...
h9_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h9_c, file = "h9_c.RData")