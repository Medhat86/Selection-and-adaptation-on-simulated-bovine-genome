...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_q2"
...
q2_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q2_s, file = "q2_s.RData")
...
q2_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q2_c, file = "q2_c.RData")