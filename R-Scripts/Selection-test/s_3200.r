...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_s3200"
...
s3200_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s3200_s, file = "s3200_s.RData")
...
s3200_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s3200_c, file = "s3200_c.RData")