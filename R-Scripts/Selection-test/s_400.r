...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_s400"
...
s400_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s400_s, file = "s400_s.RData")
...
s400_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s400_c, file = "s400_c.RData")