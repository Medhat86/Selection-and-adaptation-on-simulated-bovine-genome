...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_s12800"
...
s12800_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s12800_s, file = "s12800_s.RData")
...
s12800_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s12800_c, file = "s12800_c.RData")