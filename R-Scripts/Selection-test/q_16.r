...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_q16"
...
q16_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q16_s, file = "q16_s.RData")
...
q16_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q16_c, file = "q16_c.RData")