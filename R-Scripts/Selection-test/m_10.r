...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_m10"
...
m10_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m10_s, file = "m10_s.RData")
...
m10_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m10_c, file = "m10_c.RData")