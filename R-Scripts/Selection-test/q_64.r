...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_q64"
...
q64_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q64_s, file = "q64_s.RData")
...
q64_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q64_c, file = "q64_c.RData")