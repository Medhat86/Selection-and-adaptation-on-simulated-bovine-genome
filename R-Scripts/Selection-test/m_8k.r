...
m8k_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m8k_s, file = "m8k_s.RData")
...
m8k_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m8k_c, file = "m8k_c.RData")