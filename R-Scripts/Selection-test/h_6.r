...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_h6"
...
h6_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h6_s, file = "h6_s.RData")
...
h6_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(h6_c, file = "h6_c.RData")