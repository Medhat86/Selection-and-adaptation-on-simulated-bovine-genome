...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_s6400"
...
s6400_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s6400_s, file = "s6400_s.RData")
...
s6400_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s6400_c, file = "s6400_c.RData")