...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_q256"
...
q256_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q256_s, file = "q256_s.RData")
...
q256_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q256_c, file = "q256_c.RData")