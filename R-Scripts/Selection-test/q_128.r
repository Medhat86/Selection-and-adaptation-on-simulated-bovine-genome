...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_q128"
...
q128_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q128_s, file = "q128_s.RData")
...
q128_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q128_c, file = "q128_c.RData")