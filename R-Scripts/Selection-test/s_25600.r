...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_s25600"
...
s25600_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s25600_s, file = "s25600_s.RData")
...
s25600_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(s25600_c, file = "s25600_c.RData")