...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_m4k"
...
m4k_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m4k_s, file = "m4k_s.RData")
...
m4k_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m4k_c, file = "m4k_c.RData")