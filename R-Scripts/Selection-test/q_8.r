...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_q8"
...
q8_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q8_s, file = "q8_s.RData")
...
q8_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(q8_c, file = "q8_c.RData")