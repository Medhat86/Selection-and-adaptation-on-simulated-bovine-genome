...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_m100"
...
m100_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m100_s, file = "m100_s.RData")
...
m100_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m100_c, file = "m100_c.RData")