...
for(sim in 1:100){
  ...
  directory="/home/uni08/mahmoud1/Ghat_sim/r_m16k"
...
m16k_s <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m16k_s, file = "m16k_s.RData")
...
m16k_c <- cbind(Ghat.res, Pvals.res, Cor.res)
save(m16k_c, file = "m16k_c.RData")